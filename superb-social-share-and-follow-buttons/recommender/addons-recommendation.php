...
<div class="notice notice-info is-dismissible <?php echo esc_attr($notice['unique_id']); ?>">
    <span class="st-sa-notification-wrapper">
        <span class="st-sa-notification-wrapper-info"><?php echo esc_html__("Action Required", 'superb-social-share-and-follow-buttons'); ?></span>
        <span class="st-sa-notification-wrapper-headline"><?php echo esc_html__("Enable All Features", 'superb-social-share-and-follow-buttons'); ?></span>
