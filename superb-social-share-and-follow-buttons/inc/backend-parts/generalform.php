<div class="spbsm-follow-wrapper">
	<h2><?php esc_html(sprintf(/* translators: %s: button type */__('%s: Shortcode', 'superb-social-share-and-follow-buttons'), $currentButtons)); ?></h2>
	<div class="short-code-container">
		<div class="short-code-container-explanation">
			<p class="headline-description"><?php esc_html(sprintf(/* translators: %s: button type */__('Copy & paste the shortcode below to show the %s.', 'superb-social-share-and-follow-buttons'), strtolower($currentButtons))); ?></p>
		</div>
		<div class="short-code-container-inner">
			...
			<span class="short-code-result">[<?php echo esc_html($currentsc); ?>]</span>
		</div>
	</div>
	...
	<h2><?php echo esc_html(sprintf(/* translators: %s: button type */__('%s: Posts & Pages', 'superb-social-share-and-follow-buttons'), $currentButtons)); ?></h2>
	<p class="headline-description"><?php echo esc_html(sprintf(/* translators: %s: button type */__('Choose where you want the social media %s to display on posts and pages.', 'superb-social-share-and-follow-buttons'), strtolower($currentButtons))); ?></p>
	<table>
		<tr>
			<td>
	...
	<h2><?php echo esc_html(sprintf(/* translators: %s: button type */__('%s: Floating Sidebar', 'superb-social-share-and-follow-buttons'), $currentButtons)); ?></h2>
	<p class="headline-description"><?php echo esc_html(sprintf(/* translators: %s: button type */__('Choose settings for the social media %s floating sidebar.', 'superb-social-share-and-follow-buttons'), strtolower($currentButtons))); ?></p>
	<table>
		<tr>
			<td>
			...
			<td>
				<select name="floatingSidebar">
					<option value="0" <?php echo ($positionSettings['floatingSidebar'] == 0 ? 'selected' : '') ?>><?php echo esc_html__("Off", 'superb-social-share-and-follow-buttons'); ?></option>
					<option value="1" <?php echo ($positionSettings['floatingSidebar'] == 1 ? 'selected' : '') ?>><?php echo esc_html__("Left Center", 'superb-social-share-and-follow-buttons'); ?></option>
					<option value="2" <?php echo ($positionSettings['floatingSidebar'] == 2 ? 'selected' : '') ?>><?php echo esc_html__("Right Center", 'superb-social-share-and-follow-buttons'); ?></option>
					<option value="3" <?php echo ($positionSettings['floatingSidebar'] == 3 ? 'selected' : '') ?>><?php echo esc_html__("Bottom Right", 'superb-social-share-and-follow-buttons'); ?></option>
					<option value="4" <?php echo ($positionSettings['floatingSidebar'] == 4 ? 'selected' : '') ?>><?php echo esc_html__("Bottom Left", 'superb-social-share-and-follow-buttons'); ?></option>
				</select>
			</td>
		</tr>
		<tr>
